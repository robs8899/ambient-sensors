  ...
  <xsl:template match="/">
    ...
    <html>
      ...
      <body>
        ...
        <img class="bannerImage" src="{$contextPath}/img/bkgr1.jpg" />

          <h1>
            <table style="width:100%;"><tr>
            <td style="width:auto;text-align:left;"><xsl:value-of select="model:station/@name" /></td>
            <td style="width:40px;text-align:right;"><a href="{$requestURI}?target=charts">
              <img src="{$contextPath}/img/chart.png" style="margin:4px;vertical-align:middle;" />
            </a></td>
            </tr></table>
          </h1>
            ...
            <xsl:for-each select="model:sensor">
              ...
              <div class="itemBox">
                ...
                <table class="tb1 wFull">
                  ...
                  <tr class="tr1">
                    <td class="tdl b" colspan="3">
                      <xsl:value-of select="model:sample/@timestamp" />
                    </td>
                  </tr>
                  <xsl:for-each select="model:sample/model:value">
                    <tr class="tr1">
                      <td class="tdl">
                        <xsl:value-of select="@name" />
                      </td>
